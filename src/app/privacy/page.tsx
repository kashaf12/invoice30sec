...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://invoice30sec.com/privacy",
  },
};
      ...
      <Section id="privacy" className="bg-transparent">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="space-y-6 text-secondary-foreground leading-relaxed">
            ...
            <p>
              Welcome to Invoice30Sec. We respect your privacy and are committed
            ...
            <p>
              ...
              practices, please contact us at: support@invoice30sec.com
            </p>
          </div>
        </div>
      </Section>
